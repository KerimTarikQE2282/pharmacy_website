...
function TransferInventoryForm({items,WareHouses,stores,makePOSTApiRequest}) {
  const [selection, setSelection] = React.useState('single');
    ...
    async function onSubmit(data){
      console.log("🚀 ==> file: AddInventoryForm.jsx:18 ==> onSubmit ==> data:", data);
          ...
          makePOSTApiRequest('WareHouseAdjustments/sendtostore',setLoading,data,'ToStoreSending')
